...
if (isset($_REQUEST['good'])) {
  ...
  header('Location: http://localhost:8888/liko_201223/web/userpage.php');
  exit();
...
<div class="container-fluid">
      ...
      <section class="container-fluid tweetContents-reaction pt-4">
        ...
        <div class="row">
          ...
          <div class="col-md-2 reaction-space">
            ...
            <?php if ($goodFlag) : ?>
              <a class="btn btn-danger btn-sm disabled" role="button" href="userpage.php?good=<?= h($post['id']); ?>">
                <i class="good fas fa-heart"></i> <?= h($post['good']); ?>
              </a>
            <?php else: ?>
              <a class="btn btn-outline-danger btn-sm" role="button" href="userpage.php?good=<?= h($post['id']); ?>">
                <i class="good fas fa-heart"></i> <?= h($post['good']); ?>
              </a>
            <?php endif; ?>
  ...
  <nav class="col-md-10 offset-md-2 page-wrapper" aria-label="ページネーション">
    <ul class="pagination">
      <?php if ($page > 1) : ?>
      <li class="page-item">
        <a class="page-link" href="userpage.php?page=<?= $page - 1 ?>">前</a>
      </li>
      <?php else: ?>
      ...
      <li class="page-item">
        <a class="page-link" href="index.php">ホームへ</a>
      </li>

      <?php if ($page < $maxPage) : ?>
      <li class="page-item">
        <a class="page-link" href="userpage.php?page=<?= $page + 1 ?>">次</a>
      </li>
      <?php else: ?>
        <li class="page-item disabled">
